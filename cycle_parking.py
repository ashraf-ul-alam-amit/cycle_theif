...
cycle_person_iou = np.zeros((3, 1000)).astype(int)
...
vid = cv2.VideoCapture("./videos/test/video_20230515_180551.mp4")
...
while True:
    ...
    if len(person)>0 and len(bicycle)>0:
        ...
        for person_id, cycle_id in nearest_pc_pairs.items():
            ...
            if(iou_>10 and cycle_person_iou[0][cycle_id]==0):
            ...
            elif(iou_>10 and cycle_person_iou[0][cycle_id]==person_id):

                cycle_person_iou[2][cycle_id]=cycle_person_iou[2][cycle_id]+1
                if iou_>=cycle_person_iou[1][cycle_id]:
                    cycle_person_iou[1][cycle_id]=iou_


            elif(iou_>10 and cycle_person_iou[0][cycle_id]!=person_id and iou_>cycle_person_iou[1][cycle_id]):
                cycle_person_iou[0][cycle_id]=person_id
                cycle_person_iou[1][cycle_id]=iou_
            ...
            if (cycle_person_iou[2][cycle_id]>min_frame and fixed_cp_iou[0][cycle_id]==0):
                ...
                if (cycle_person_iou[2][cycle_id]<=max_frame):
                    # face_save(cycle_id,img,dict_of_bbox[fixed_cp_iou[0][cycle_id]],cycle_person_iou[2][cycle_id])
                    print(cycle_id,dict_of_bbox[fixed_cp_iou[0][cycle_id]],cycle_person_iou[2][cycle_id])
                
            elif (cycle_person_iou[2][cycle_id]>=min_frame and fixed_cp_iou[0][cycle_id]!=cycle_person_iou[0][cycle_id]):
                None #print("alarm ",cycle_id,fixed_cp_iou[0][cycle_id])
